...
class paypal
{
	...
	var $submit_button = '<input type="submit" value="Click here if you are not redirected within 10 seconds" />';


	function __constructor($price_item=0)
	{
	...
	function validate_ipn()
	{
		if(!empty($_POST))
		{
			...
			//mail('manuel.tanase@gmail.com','PP BMMO TEST','str='.$str.''."\n\n\n".'postvars='.$postvars);
	...
	function output_form()
	{
		...
		echo '<form name="f" action="'.$this->form_action.'" method="post">';
	...
	function log_results($var)
	{
		...
		//chk mail
		mail("manuel.tanase@gmail.com","IPN log BROWSER MMORPG",$str);
